...
const translations = {
  vi: {
    ...
    // My Bookings
    yourBookings: "Lịch sử đặt vé của bạn",
    noBookings: "Bạn chưa có chuyến đi nào. Hãy đặt vé ngay nhé!",
    status: "Trạng thái",
    paid: "Đã thanh toán",
  ...
  en: {
    ...
    noBookings: "You have no trips yet. Book a ticket now!",
    status: "Status",
    paid: "Paid",
    confirmed: "Confirmed",
    completed: "Completed",
  ...
  ja: {
    ...
    // My Bookings
    yourBookings: "予約履歴",
    noBookings: "まだ旅行がありません。今すぐ予約しましょう！",
    status: "ステータス",
    paid: "支払い済み",
    confirmed: "確認済み",
    completed: "完了",
